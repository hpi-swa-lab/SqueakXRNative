// taken from https://www.raylib.com/examples/text/loader.html?name=text_3d_drawing
#include <raylib.h>
#include <rlgl.h>
...
extern "C" void DrawTextCodepoint3D(Font font, int codepoint, Vector3 position, float fontSize, bool backface, Color tint)
{
...
extern "C" void DrawText3D(Font font, const char *text, Vector3 position, float fontSize, float fontSpacing, float lineSpacing, bool backface, Color tint)
{
